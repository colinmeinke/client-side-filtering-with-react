...
_apiFilters2['default'].title.selected = true;

var props = {
  'covers': _apiCovers2['default'],
  'filters': _apiFilters2['default'],
  'initialTerm': ''
};

for (var key in _apiFilters2['default']) {
  if (_apiFilters2['default'][key].selected) {
    props.initialFilterKey = key;
    props.initialFilterName = _apiFilters2['default'][key].name;
  }
}

_react2['default'].render(_react2['default'].createElement(_componentsFilterFilter2['default'], props), document.body);

},{"./api/covers":1,"./api/filters":2,"./components/filter/filter":7,"react":164}],4:[function(require,module,exports){
'use strict';
...
},{"../select/select":8,"react":164}],6:[function(require,module,exports){
"use strict";
    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          "h2",
          { className: "container" },
          _react2["default"].createElement("small", { dangerouslySetInnerHTML: { '__html': this.props.title } })
        )
      );
    }
  }]);
...
},{"../covers/covers-list":4,"./filter-form":5,"./filter-header":6,"react":164}],8:[function(require,module,exports){
'use strict';
